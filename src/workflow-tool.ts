...
const workflowToolSchema = Type.Object({
  script: Type.String({
    description: [
      ...
      "Use phase('Name'), agent(prompt, opts), parallel(arrayOfFunctions), pipeline(items, ...stages), handoff(value, opts), log(message), args, and budget. The workflow must call agent() at least once.",
